...
const FeaturedProjects = () => {
  ...
  const projects = [
    {
      id: 1,
      name: "Artician Marketplace",
      subtitle: "E-Commerce Platform",
      desc: "A dedicated digital marketplace connecting artists with global collectors. Features seamless payments, portfolio management, and a robust search engine.",
      tech: ["React", "Node.js", "MongoDB"],
      link: "https://github.com/Rajas-Patil/Artician-Marketplace",
    ...
    },
    {
      ...
      desc: "Decentralized disaster relief distribution system ensuring 100% transparency and traceability of funds using Smart Contracts.",
      tech: ["Solidity", "Web3", "Ethereum"],
      link: "https://github.com/Rajas-Patil/ReliefChain",
    ...
    },
    {
      ...
      desc: "Advanced steganography application allowing users to securely conceal secret messages within image files using encryption algorithms.",
      tech: ["Python", "Cryptography", "Security"],
      link: "https://github.com/Rajas-Patil/ImageStegano",
      image: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?q=80&w=2664&auto=format&fit=crop",
      size: "medium"
    },
    {
      id: 4,
      name: "Face Emotion AI",
      subtitle: "Computer Vision",
      desc: "Real-time facial expression recognition system capable of detecting complex emotional states with high accuracy using Deep Learning.",
      tech: ["OpenCV", "TensorFlow", "CNN"],
      link: "https://github.com/Rajas-Patil/Expresion_Recogination",
